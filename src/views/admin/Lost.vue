      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-gray-600">
            분실물 신고를 확인하고 처리 상태를 관리할 수 있습니다
          </p>
        </div>
        ...
        <div v-if="selectedItem" class="p-6 space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
              <p class="mt-1 text-sm text-gray-900">
                {{ formatDate(selectedItem.c_date) }}
              </p>
            </div>
          </div>
          ...
          <div class="flex items-center justify-between pt-4 border-t">
            ...
            <div class="flex space-x-2">
              ...
              <button
                @click="contactOwner(selectedItem)"
                class="btn btn-outline"
              >
                연락하기
              </button>
  ...
  setup() {
    ...
    const todayCount = computed(() => {
      ...
      return lostItems.value.filter(
        (item) => new Date(item.c_date).toDateString() === today
      ).length;
    });
