<template>
  <div class="lost-form">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
      ...
      <p class="text-gray-600">버스에서 잃어버린 물건을 신고해주세요. 발견 시 연락드리겠습니다.</p>
    </div>
    ...
    <div class="card p-6">
      <form @submit.prevent="submitForm">
        ...
        <div class="flex gap-4 justify-end">
          <router-link to="/lost" class="btn btn-outline">
            취소
          </router-link>
    ...
    <div class="mt-8 card p-6 bg-blue-50 border-blue-200">
      ...
      <div class="space-y-2 text-blue-800 text-sm">
        ...
        <p class="flex items-start">
          ...
          문의: 031-123-4567 (평일 09:00~18:00)
        </p>
      </div>
    </div>
        ...
        <div class="mt-3">
          ...
          <div class="text-sm text-gray-700 space-y-4 max-h-96 overflow-y-auto">
            ...
            <div>
              ...
              <p>개인정보 수집에 동의하지 않을 권리가 있으나, 동의 거부 시 분실물 신고 서비스 이용이 제한될 수 있습니다.</p>
            </div>
          </div>
