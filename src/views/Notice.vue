<template>
  <div class="notice">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
      ...
      <p class="text-gray-600">백성운수의 중요한 공지사항을 확인하세요</p>
    </div>
      ...
      <div class="overflow-x-auto">
        <table class="table w-full">
          <thead class="bg-gray-50">
            <tr>
              <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">분류</th>
              <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">제목</th>
              <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">작성일</th>
              <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">첨부</th>
            </tr>
          </thead>
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            >
              ...
              <td class="px-6 py-4">
                <div class="text-sm font-medium text-gray-900 hover:text-primary-600">
                  {{ notice.title }}
                </div>
